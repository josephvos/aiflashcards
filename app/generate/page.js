...
import { AppBar, Box, Button, Container, Typography, Paper, TextField, Card, CardContent, CardActionArea, Grid, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from '@mui/material';
...
export default function Generate() {
    ...
    const saveFlashcards = async () => {
        ...
        const userDocRef = doc(db, 'users', user.id); // Store flashcards under the user document
        const flashcardSetDocRef = doc(collection(userDocRef, 'flashcard_sets'), name);
